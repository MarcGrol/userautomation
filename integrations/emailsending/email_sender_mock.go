...
// Package emailsending is a generated GoMock package.
...
func (m *MockEmailSender) Send(c context.Context, recipient, subject, body string) error {
	m.ctrl.T.Helper()
...
func (mr *MockEmailSenderMockRecorder) Send(c, recipient, subject, body interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Send", reflect.TypeOf((*MockEmailSender)(nil).Send), c, recipient, subject, body)
}
