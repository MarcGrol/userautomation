...
func New(bodyTemplate string, smsClient smssending.SmsSender) useraction.UserActioner {
	return &SmsAction{
...
func (ea *SmsAction) Perform(ctx context.Context, a useraction.UserAction) error {
